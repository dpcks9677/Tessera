...
> **보관 사유**: `M17-T19`가 폐기(`DROPPED`)되어 보관합니다. 절차적 깃펜을 외부 FBX로 교체하면서 이 계획의 전제가 무너졌습니다.
>
> 여기 적힌 파일 경로와 클래스명 일부는 현재 존재하지 않을 수 있습니다. 이 문서를 실행 지침으로 쓰지 마십시오. 보관 색인은 [`archive/README.md`](../README.md)입니다.

작성일: 2026-09-09 · 개정: 2026-09-12 · 상태: `DROPPED` · 요약은 [`docs/augmented_yacht_work_plan.md`](../../agent/work_plan.md) §7 `M17` 표에 있다.
