...
> **보관 사유**: PoC 시기의 영문 기술 노트입니다. 원래 `Assets/Docs/README.md`였고, Unity 에셋 DB 안에 문서가 있으면 `.meta`가 따라붙어 밖으로 옮겼습니다. 깃펜 FBX 출처·라이선스 항목은 `docs/reference/art_style_guide.md`로 옮겼습니다.
>
