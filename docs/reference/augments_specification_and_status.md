...
> **구현 현황 종합**:
> - **완전 구현 및 검증 완료**: **46종 (DONE)** (`coin-toss` 포함, 2026-09-15 EditMode·Play Mode 시각 확인 통과. 효과음은 `M17-T13`으로 이관)
> - **의도적 미구현 및 기획 보류**: **3종 (HOLD)** (`four-by-four`, `two-households`, `strange-die`)
...
| **50** | `coin-toss` | 코인 토스 | 첫 굴림 후 (게임당 1회) | 동전 3개를 던져 앞면 수에 따라 분기: 0개 -5점 / 1개 최저 주사위 6 고정 / 2개 이번 턴 리롤 +1 / 3개 상단 보너스 기준 min(현재, 57)로 완화 | `CoinToss` | `DONE` |
