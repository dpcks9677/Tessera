...
GITHUB_REPO_URL = "https://github.com/dpcks9677/Tessera/blob/main"
...
def convert_links(html_content):
    ...
    # 같은 폴더와 art/ 하위 문서는 docs/reference 아래를 가리킨다
    html_content = re.sub(r'href="(art/[a-zA-Z0-9_\-]+\.md)"', f'href="{GITHUB_REPO_URL}/docs/reference/\\1"', html_content)
    html_content = re.sub(r'href="([a-zA-Z0-9_\-]+\.md)"', f'href="{GITHUB_REPO_URL}/docs/reference/\\1"', html_content)
    return html_content
...
if __name__ == "__main__":
    base_dir = os.path.join("docs", "reference")
    files = [
