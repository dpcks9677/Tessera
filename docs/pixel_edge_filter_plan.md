...
이 문서는 `docs/augmented_yacht_work_plan.md`의 `M12` 마일스톤을 뒷받침하는 기술 상세다.
...
- 명암만으로 형태를 읽히게 하려고 개별 에셋의 색값을 손으로 조정해야 했다
  (`docs/augmented_yacht_m7_graphics_plan.md` 부록 B 참조).
...
`TesseraPixelPalette`가 `docs/art_style_guide.md` §4의 컬러 토큰 8개를 단일 출처로 삼아
